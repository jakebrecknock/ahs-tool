...
function getCategoryIcon(categoryId) {
    const icons = {
        bathroom: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 5h-6V3H8v2H2v15h20V5h-4zm-1 12h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2zm4 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z"/></svg>`,
        kitchen: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 2.01L6 2a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.11-.9-1.99-2-1.99zM18 20H6v-9.02h12V20zm0-11H6V4h12v5zM8 5h2v3H8zm0 7h2v5H8z"/><path d="M12 5h2v3h-2zM12 12h2v5h-2z"/></svg>`,
        bedroom: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 5.5c-3.89 0-6.95-.84-8.69-1.43A.993.993 0 0 0 2 5.02V19c0 .68.47 1.25 1.1 1.4l8.9 2.5c.21.06.44.06.65 0l8.9-2.5c.63-.15 1.1-.72 1.1-1.4V5.02c0-.68-.47-1.25-1.1-1.4C18.95 4.66 15.89 5.5 12 5.5zm0 13.5c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/><path d="M12 15c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>`,
        decking: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 9V6h-2v3h-3v2h3v3h2v-3h3V9zM4 6h4v12H4zm10 0h4v12h-4z"/><rect x="4" y="4" width="4" height="2"/><rect x="10" y="4" width="4" height="2"/></svg>`,
        garage: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM8 20H5v-2h3v2zm0-4H5v-2h3v2zm0-4H5v-2h3v2zm6 8h-3v-2h3v2zm0-4h-3v-2h3v2zm0-4h-3v-2h3v2zm5 8h-3v-2h3v2zm0-4h-3v-2h3v2zm0-4h-3v-2h3v2z"/><path d="M17 8.5c0-.83-.67-1.5-1.5-1.5S14 7.67 14 8.5s.67 1.5 1.5 1.5S17 9.33 17 8.5zm-4 3c0-.83-.67-1.5-1.5-1.5S10 10.67 10 11.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5z"/></svg>`,
        basement: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 15v2H5v-2h14m2-10H3v2h18V5zm0 4H3v2h18V9zm0 4H3v6h18v-6z"/><path d="M5 15h2v2H5zm4 0h2v2H9zm4 0h2v2h-2z"/></svg>`,
        flooring: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 6h16v2H4zm0 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4z"/><rect x="4" y="4" width="4" height="2"/><rect x="10" y="4" width="4" height="2"/><rect x="16" y="4" width="4" height="2"/></svg>`,
        concrete: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3 15h18v2H3zm0 4h18v2H3zm0-8h18v2H3zm0-4h18v2H3zm0-4h18v2H3z"/><rect x="3" y="3" width="4" height="2"/><rect x="9" y="3" width="4" height="2"/><rect x="15" y="3" width="4" height="2"/></svg>`,
        glass: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3 5h2v14H3zm4 0h2v14H7zm4 0h2v14h-2zm4 0h2v14h-2zm4 0h2v14h-2z"/><path d="M12 8l-1.41 1.41L16.17 14H6v2h10.17l-5.58 5.59L12 22l8-8z"/></svg>`,
        repairs: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19.79 15.12c-1.21.54-2.05 1.71-2.05 3 0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5c0-1.04-.46-1.97-1.18-2.61l-3.06-2.88-1.06 1.06 2.48 2.34c.15.14.23.34.23.54 0 .41-.34.75-.75.75s-.75-.34-.75-.75c0-.2.08-.39.22-.53l2.22-2.22-5.25-5.25-2.22 2.22c-.14.14-.33.22-.53.22-.41 0-.75-.34-.75-.75s.34-.75.75-.75c.2 0 .39.08.53.22l2.22 2.22 1.06-1.06-2.22-2.22c-.14-.14-.22-.33-.22-.53 0-.41.34-.75.75-.75s.75.34.75.75c0 .2-.08.39-.22.53l-2.22 2.22 5.25 5.25 2.34-2.34 1.06 1.06-2.88 3.06zM12 8.19L7 3.19 3.19 7 8.19 12l-5 5L7 20.81l5-5 5 5L20.81 17l-5-5z"/></svg>`
    };
