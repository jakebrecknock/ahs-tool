...
const pricingData = {
    ...
    // ... (include all other categories from your pricing data)
    // Note: I've omitted the full list here for brevity, but you should include all categories
};
...
function loadEstimates() {
  ...
  if (estimates.length === 0) {
    quoteList.innerHTML = '<div class="no-results"><i class="fas fa-info-circle"></i> No estimates yet</div>';
    return;
  }
